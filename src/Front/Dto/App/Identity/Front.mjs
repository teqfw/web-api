 ...
 */
// MODULE'S VARS
const NS = 'TeqFw_Web_Api_Front_Dto_App_Identity_Front';

/**
 * @memberOf TeqFw_Web_Api_Front_Dto_App_Identity_Front
 * @type {Object}
 */
const ATTR = {
    FRONT_ID: 'frontId',
 ...
 */
export default class TeqFw_Web_Api_Front_Dto_App_Identity_Front {
    ...
    constructor(spec) {
        ...
        // INSTANCE METHODS
        /**
         * @param {TeqFw_Web_Api_Front_Dto_App_Identity_Front.Dto} data
         * @return {TeqFw_Web_Api_Front_Dto_App_Identity_Front.Dto}
         */
