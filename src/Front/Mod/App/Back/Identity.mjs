 ...
 */
export default class TeqFw_Web_Api_Front_Mod_App_Back_Identity {
    constructor(spec) {
        // DEPS
        ...
        /** @type {TeqFw_Web_Api_Front_Dto_App_Identity_Back} */
        const dtoIdentity = spec['TeqFw_Web_Api_Front_Dto_App_Identity_Back$'];

        // VARS
        const KEY_IDENTITY = `${DEF.SHARED.NAME}/back/identity`;
        /** @type {TeqFw_Web_Api_Front_Dto_App_Identity_Back.Dto} */
        let _cache;
