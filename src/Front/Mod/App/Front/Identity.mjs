 ...
 */
export default class TeqFw_Web_Api_Front_Mod_App_Front_Identity {
    constructor(spec) {
        // DEPS
        ...
        /** @type {TeqFw_Web_Api_Front_Dto_App_Identity_Front} */
        ...
        /** @type {TeqFw_Web_Api_Front_Dto_App_Identity_Front.Dto} */
        let _cache;
